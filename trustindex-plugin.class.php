<?php
class TrustindexPlugin_opentable
{
...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-12.4.1", "do-not-care-Widgets for Opentable Reviews", "do-not-care-Opentable");
