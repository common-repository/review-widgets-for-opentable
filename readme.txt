...
Tags: opentable, restaurant, reviews, ratings, recommendations
...
Plugin Name: Widgets for Opentable Reviews
Plugin Title: Widgets for Opentable Reviews Plugin
Plugin URI: https://wordpress.org/plugins/review-widgets-for-opentable/
Author: Trustindex.io <support@trustindex.io>
Author URI: https://www.trustindex.io/
Text Domain: review-widgets-for-opentable
Version: 12.4.1
...
[vimeo https://player.vimeo.com/video/506436083]
...
* Free usage
* Display up to 10 Opentable reviews
* 40+ Widget layouts
...
[Create a Free Account for More Features](https://www.trustindex.io/ti-redirect.php?a=sys-wp&c=opentable.php-r1)
...
[Create a Free Account for More Features](https://www.trustindex.io/ti-redirect.php?a=sys-wp&c=opentable.php-r2)
...
Our Widgets for Opentable Reviews supports the following languages:
...
If you have any issues at all setting up the Opentable reviews WordPress Plugin for your business, you can contact our customer support team in various ways.

We offer 24/7 email support in English.

We recommend the following order when searching for answers:
1. Plugin FAQ here at the bottom - if you don’t already know why it’s worth displaying Opentable reviews
...
4. Check topics or ask a new question here: [Support Forum](https://wordpress.org/support/plugin/review-widgets-for-opentable/)
...
This FAQ is for you if you do not already know why it’s worth displaying Opentable reviews.
