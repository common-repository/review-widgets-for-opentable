...
$stepList = [
sprintf(__('Connect %s', 'trustindex-plugin'), 'Opentable'),
...
<h1 class="ti-header-title"><?php echo sprintf(__('Connect %s', 'trustindex-plugin'), 'Opentable'); ?></h1>
...
<?php else: ?>
<div class="ti-box">
<form method="post" action="" data-platform="opentable" id="ti-connect-platform-form">
...
$labelText = sprintf(__('%s Business URL', 'trustindex-plugin'), 'Opentable');
$infoText = __("Type your business/company's URL and select from the list", 'trustindex-plugin');
$errorText = sprintf(__('Please add your URL again: this is not a valid %s page.', 'trustindex-plugin'), "Opentable");
...
<?php endif; ?>
<h1 class="ti-header-title ti-mt-2"><?php echo sprintf(__('Check some %s widget layouts and styles', 'trustindex-plugin'), 'Opentable reviews'); ?></h1>
...
<p>
<?php echo sprintf(__('There are no reviews on your %s platform.', 'trustindex-plugin'), 'Opentable'); ?>
</p>
</div>
<?php endif; ?>
...
<?php endif; ?>
<?php
$tiCampaign1 = 'wp-opentable-1';
$tiCampaign2 = 'wp-opentable-2';
