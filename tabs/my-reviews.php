...
$text = "";
$link = "https://cdn.trustindex.io/assets/platform/".ucfirst("opentable")."/star/";
if (!is_numeric($score)) {
return $text;
}
...
<?php echo $pluginManagerInstance->getProFeatureButton('wp-opentable-pro'); ?>
</div>
...
<td class="ti-text-center source-<?php echo ucfirst("opentable") ?>"><?php echo trustindex_plugin_write_rating_stars($review->rating); ?></td>
...
<?php endif; ?>
<a href="<?php echo esc_attr($review->id); ?>" data-nonce="<?php echo wp_create_nonce('ti-save-reply'); ?>" class="ti-btn ti-btn-sm btn-post-reply"><?php echo sprintf(__('Upload reply to %s', 'trustindex-plugin'), 'Opentable'); ?></a>
...
<?php endif; ?>
<?php
$tiCampaign1 = 'wp-opentable-4';
$tiCampaign2 = 'wp-opentable-5';
